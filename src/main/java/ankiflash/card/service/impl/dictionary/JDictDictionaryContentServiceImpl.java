...
public class JDictDictionaryContentServiceImpl extends DictionaryContentServiceImpl {

  private static final Logger logger =
      LoggerFactory.getLogger(JDictDictionaryContentServiceImpl.class);
  ...
  public boolean isConnected(String combinedWord, Translation translation) {
    ...
    doc = CardHelper.getJDictDoc(Constant.JDICT_URL_VN_JP_OR_JP_VN, urlParameters);
    return doc == null;
  }
  ...
  public void getSounds(String ankiDir, boolean isOffline) {
    ...
    this.ankiDir = ankiDir;
    soundLinks = HtmlHelper.getAttribute(doc, "a.sound", 0, "data-fn");
  ...
  private List<String> getJDictExamples(Elements exampleElms) {
    ...
    if (!exampleElms.isEmpty()) {
      ...
      Document doc = CardHelper.getJDictDoc(Constant.JDICT_URL_VN_JP_OR_JP_VN, urlParams);

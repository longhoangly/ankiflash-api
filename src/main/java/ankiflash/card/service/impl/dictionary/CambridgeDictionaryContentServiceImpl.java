...
public class CambridgeDictionaryContentServiceImpl extends DictionaryContentServiceImpl {

  private static final Logger logger =
      LoggerFactory.getLogger(CambridgeDictionaryContentServiceImpl.class);
  ...
  public boolean isConnected(String combinedWord, Translation translation) {
    ...
    if (translation.equals(Translation.EN_CN_TD)) {
      url = HtmlHelper.lookupUrl(Constant.CAMBRIDGE_URL_EN_CN_TD, this.wordId);
    } else if (translation.equals(Translation.EN_CN_SP)) {
      url = HtmlHelper.lookupUrl(Constant.CAMBRIDGE_URL_EN_CN_SP, this.wordId);
    } else if (translation.equals(Translation.EN_FR)) {
      url = HtmlHelper.lookupUrl(Constant.CAMBRIDGE_URL_EN_FR, this.wordId);
    } else if (translation.equals(Translation.EN_JP)) {
      url = HtmlHelper.lookupUrl(Constant.CAMBRIDGE_URL_EN_JP, this.wordId);
    }
  ...
  public boolean isInvalidWord() {
    ...
    if (title.contains(Constant.CAMBRIDGE_SPELLING_WRONG)) {
      return true;
    }

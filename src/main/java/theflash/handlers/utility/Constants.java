...
public class Constants {
  ...
  public static String ANKI_DIR_FLASHCARDS = ".\\AnkiFlashcards";
  public static String ANKI_DIR_OXFORD = Paths.get(ANKI_DIR_FLASHCARDS, "oxlayout").toString();
  public static String ANKI_DIR_SOHA = Paths.get(ANKI_DIR_FLASHCARDS, "soha").toString();
  public static String ANKI_DIR_LACVIET = Paths.get(ANKI_DIR_FLASHCARDS, "lacViet").toString();
  public static String ANKI_DIR_CAMBRIDGE = Paths.get(ANKI_DIR_FLASHCARDS, "cambridge").toString();
  public static String ANKI_DIR_COLLINS = Paths.get(ANKI_DIR_FLASHCARDS, "collins").toString();
  public static String ANKI_DIR_SOUND = Paths.get(ANKI_DIR_FLASHCARDS, "sounds").toString();
  public static String ANKI_DIR_IMAGE = Paths.get(ANKI_DIR_FLASHCARDS, "images").toString();
